...
![CodeBurn](https://img.shields.io/badge/python-3.10%2B-blue) ![deps](https://img.shields.io/badge/depend%C3%AAncias-zero-green) ![license](https://img.shields.io/badge/licen%C3%A7a-MIT-green)
...
**Ajustar os preços.** A tabela fica no `pricing.json`. Confira os valores atuais na [página de preços da Anthropic](https://www.anthropic.com/pricing) e ajuste se precisar. O rodapé do dashboard mostra a data em que os preços foram conferidos pela última vez, então você sempre sabe o quão atual está. Tem também o campo `usd_brl` pra converter pra real, mude pra sua moeda se quiser.
...
Pra adivinhar o nome do projeto de cada sessão, o CodeBurn lê o texto das suas conversas localmente. Esse texto nunca sai da sua máquina: serve só pra classificação e é descartado logo em seguida. Nenhum conteúdo de conversa é gravado no relatório nem transmitido.
